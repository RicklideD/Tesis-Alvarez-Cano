...
class Inferer:
    ...
    def _infer_one(self, model, data_item, preproc_item, beam_size, output_history=False, use_heuristic=True):
        if use_heuristic:
            # TODO: from_cond debería ser verdadero para el modelo que no es Bert
